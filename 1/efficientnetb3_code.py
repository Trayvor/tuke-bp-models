...
IMG_HEIGHT = 256
IMG_WIDTH = 256
BATCH_SIZE = 8    # less bc of model complexity
EPOCHS = 100
...
checkpoint = callbacks.ModelCheckpoint('efficientnetb3_model.h5', monitor='val_loss', save_best_only=True)
...
with open(os.path.join(history_dir, 'efficientnetb3_history.json'), 'w') as f:
