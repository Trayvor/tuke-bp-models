...
DROPOUT_RATE = 0.3 # less dropout bc of number of layers
PATIENCE = 3
NUM_CLASSES = 1
...
checkpoint = callbacks.ModelCheckpoint('efficientnetb0_model.h5', monitor='val_loss', save_best_only=True)
...
model.save('./efficientnetb0_final_model.h5')
