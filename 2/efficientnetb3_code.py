...
model = tf.keras.models.load_model('./exp1/efficientnetb3_final_model.h5')
with open('./exp1/efficientnetb3_history.json', 'r') as f:
...
checkpoint_fine = callbacks.ModelCheckpoint('efficientnetb3_finetuned_model.keras', monitor='val_loss', save_best_only=True)
...
model.save('./exp2/efficientnetb3_finetuned_model.keras')

with open('./efficientnetb3_finetune_history.json', 'w') as f:
...
plt.suptitle("EfficientNetB3 Combined Training\n(Pre-training + Fine-tuning)", fontsize=16)
